...
@FacesConverter(value = "aprendizConverter")
public class AprendizConverter implements Converter {

    private AprendizFacade ejbFacade;
    ...
    private AprendizFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(AprendizFacade.class).get();
