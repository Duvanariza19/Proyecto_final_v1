...
@FacesConverter(value = "fichaConverter")
public class FichaConverter implements Converter {

    private FichaFacade ejbFacade;
    ...
    private FichaFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(FichaFacade.class).get();
